...
('ESV', 'Habakkuk', 1, 1, 'The oracle that Habakkuk the prophet saw.');
INSERT INTO BIBLE VALUES 
...
INSERT INTO BIBLE VALUES 
('ESV', 'Habakkuk', 1, 4, 'So the law is paralyzed, and justice never goes forth. For the wicked surround the righteous; so justice goes forth perverted.');
INSERT INTO BIBLE VALUES 
...
INSERT INTO BIBLE VALUES 
('ESV', 'Habakkuk', 1, 8, 'Their horses are swifter than leopards, more fierce than the evening wolves; their horsemen press proudly on. Their horsemen come from afar; they fly like an eagle swift to devour.');
INSERT INTO BIBLE VALUES 
...
INSERT INTO BIBLE VALUES 
('ESV', 'Habakkuk', 1, 13, 'You who are of purer eyes than to see evil and cannot look at wrong, why do you idly look at traitors and are silent when the wicked swallows up the man more righteous than he?');
INSERT INTO BIBLE VALUES 
...
INSERT INTO BIBLE VALUES 
('ESV', 'Habakkuk', 2, 2, 'And the LORD answered me: "Write the vision; make it plain on tablets, so he may run who reads it.');
INSERT INTO BIBLE VALUES 
('ESV', 'Habakkuk', 2, 3, 'For still the vision awaits its appointed time; it hastens to the end- it will not lie. If it seems slow, wait for it; it will surely come; it will not delay.');
INSERT INTO BIBLE VALUES 
('ESV', 'Habakkuk', 2, 4, '"Behold, his soul is puffed up; it is not upright within him, but the righteous shall live by his faith.');
INSERT INTO BIBLE VALUES 
('ESV', 'Habakkuk', 2, 5, '"Moreover, wine is a traitor, an arrogant man who is never at rest. His greed is as wide as Sheol; like death he has never enough. He gathers for himself all nations and collects as his own all peoples."');
INSERT INTO BIBLE VALUES 
('ESV', 'Habakkuk', 2, 6, 'Shall not all these take up their taunt against him, with scoffing and riddles for him, and say, "Woe to him who heaps up what is not his own- for how long?- and loads himself with pledges!"');
INSERT INTO BIBLE VALUES 
('ESV', 'Habakkuk', 2, 7, 'Will not your debtors suddenly arise, and those awake who will make you tremble? Then you will be spoil for them.');
INSERT INTO BIBLE VALUES 
('ESV', 'Habakkuk', 2, 8, 'Because you have plundered many nations, all the remnant of the peoples shall plunder you, for the blood of man and violence to the earth, to cities and all who dwell in them.');
INSERT INTO BIBLE VALUES 
('ESV', 'Habakkuk', 2, 9, '"Woe to him who gets evil gain for his house, to set his nest on high, to be safe from the reach of harm!');
INSERT INTO BIBLE VALUES 
('ESV', 'Habakkuk', 2, 10, 'You have devised shame for your house by cutting off many peoples; you have forfeited your life.');
INSERT INTO BIBLE VALUES 
('ESV', 'Habakkuk', 2, 11, 'For the stone will cry out from the wall, and the beam from the woodwork respond.');
INSERT INTO BIBLE VALUES 
('ESV', 'Habakkuk', 2, 12, '"Woe to him who builds a town with blood and founds a city on iniquity!');
INSERT INTO BIBLE VALUES 
('ESV', 'Habakkuk', 2, 13, 'Behold, is it not from the LORD of hosts that peoples labor merely for fire, and nations weary themselves for nothing?');
INSERT INTO BIBLE VALUES 
('ESV', 'Habakkuk', 2, 14, 'For the earth will be filled with the knowledge of the glory of the LORD as the waters cover the sea.');
INSERT INTO BIBLE VALUES 
('ESV', 'Habakkuk', 2, 15, '"Woe to him who makes his neighbors drink- you pour out your wrath and make them drunk, in order to gaze at their nakedness!');
INSERT INTO BIBLE VALUES 
('ESV', 'Habakkuk', 2, 16, 'You will have your fill of shame instead of glory. Drink, yourself, and show your uncircumcision! The cup in the LORD''S right hand will come around to you, and utter shame will come upon your glory!');
INSERT INTO BIBLE VALUES 
('ESV', 'Habakkuk', 2, 17, 'The violence done to Lebanon will overwhelm you, as will the destruction of the beasts that terrified them, for the blood of man and violence to the earth, to cities and all who dwell in them.');
INSERT INTO BIBLE VALUES 
('ESV', 'Habakkuk', 2, 18, '"What profit is an idol when its maker has shaped it, a metal image, a teacher of lies? For its maker trusts in his own creation when he makes speechless idols!');
INSERT INTO BIBLE VALUES 
('ESV', 'Habakkuk', 2, 19, 'Woe to him who says to a wooden thing, Awake; to a silent stone, Arise! Can this teach? Behold, it is overlaid with gold and silver, and there is no breath at all in it.');
INSERT INTO BIBLE VALUES 
('ESV', 'Habakkuk', 2, 20, 'But the LORD is in his holy temple; let all the earth keep silence before him."');
INSERT INTO BIBLE VALUES 
('ESV', 'Habakkuk', 3, 1, 'A prayer of Habakkuk the prophet, according to Shigionoth.');
INSERT INTO BIBLE VALUES 
('ESV', 'Habakkuk', 3, 2, 'O LORD, I have heard the report of you, and your work, O LORD, do I fear. In the midst of the years revive it; in the midst of the years make it known; in wrath remember mercy.');
INSERT INTO BIBLE VALUES 
('ESV', 'Habakkuk', 3, 3, 'God came from Teman, and the Holy One from Mount Paran. His splendor covered the heavens, and the earth was full of his praise. Selah');
INSERT INTO BIBLE VALUES 
...
INSERT INTO BIBLE VALUES 
('ESV', 'Habakkuk', 3, 7, 'I saw the tents of Cushan in affliction; the curtains of the land of Midian did tremble.');
INSERT INTO BIBLE VALUES 
...
INSERT INTO BIBLE VALUES 
('ESV', 'Habakkuk', 3, 17, 'Though the fig tree should not blossom, nor fruit be on the vines, the produce of the olive fail and the fields yield no food, the flock be cut off from the fold and there be no herd in the stalls,');
INSERT INTO BIBLE VALUES 
