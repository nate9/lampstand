...
('Daniel', 2, 26, "The king said to Daniel, whose name was Belteshazzar, \"Are you able to make known to me the dream that I have seen and its interpretation?\""),
...
('Daniel', 4, 1, "King Nebuchadnezzar to all peo- ples, nations, and languages, that dwell in all the earth: Peace be multiplied to you!"),
...
('Daniel', 11, 11, "Then the king of the south, moved with rage, shall come out and fight with the king of the north. And he shall raise a great multitude, but it shall be given into his hand."),
