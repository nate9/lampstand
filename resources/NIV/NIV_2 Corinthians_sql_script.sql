...
INSERT INTO BIBLE VALUES
('NIV', '2 Corinthians', 1, 11, 'as you help us by your prayers. Then many will give thanks on our behalf for the gracious favour granted us in answer to the prayers of many.');
INSERT INTO BIBLE VALUES
...
INSERT INTO BIBLE VALUES
('NIV', '2 Corinthians', 1, 13, 'For we do not write to you anything you cannot read or understand. And I hope that,');
INSERT INTO BIBLE VALUES
...
INSERT INTO BIBLE VALUES
('NIV', '2 Corinthians', 2, 4, 'For I wrote to you out of great distress and anguish of heart and with many tears, not to grieve you but to let you know the depth of my love for you.');
INSERT INTO BIBLE VALUES
...
INSERT INTO BIBLE VALUES
('NIV', '2 Corinthians', 2, 9, 'The reason I wrote to you was to see if you would stand the test and be obedient in everything.');
INSERT INTO BIBLE VALUES
...
INSERT INTO BIBLE VALUES
('NIV', '2 Corinthians', 2, 13, 'I still had no peace of mind, because I did not find my brother Titus there. So I said good-bye to them and went on to Macedonia.');
INSERT INTO BIBLE VALUES
...
INSERT INTO BIBLE VALUES
('NIV', '2 Corinthians', 3, 1, 'Are we beginning to commend ourselves again? Or do we need, like some people, letters of recommendation to you or from you?');
INSERT INTO BIBLE VALUES
('NIV', '2 Corinthians', 3, 2, 'You yourselves are our letter, written on our hearts, known and read by everybody.');
INSERT INTO BIBLE VALUES
('NIV', '2 Corinthians', 3, 3, 'You show that you are a letter from Christ, the result of our ministry, written not with ink but with the Spirit of the living God, not on tablets of stone but on tablets of human hearts.');
INSERT INTO BIBLE VALUES
('NIV', '2 Corinthians', 3, 4, 'Such confidence as this is ours through Christ before God.');
INSERT INTO BIBLE VALUES
('NIV', '2 Corinthians', 3, 5, 'Not that we are competent in ourselves to claim anything for ourselves, but our competence comes from God.');
INSERT INTO BIBLE VALUES
('NIV', '2 Corinthians', 3, 6, 'He has made us competent as ministers of a new covenant— not of the letter but of the Spirit; for the letter kills, but the Spirit gives life.');
INSERT INTO BIBLE VALUES
('NIV', '2 Corinthians', 3, 7, 'Now if the ministry that brought death, which was engraved in letters on stone, came with glory, so that the Israelites could not look steadily at the face of Moses because of its glory, fading though it was,');
INSERT INTO BIBLE VALUES
('NIV', '2 Corinthians', 3, 8, 'will not the ministry of the Spirit be even more glorious?');
INSERT INTO BIBLE VALUES
('NIV', '2 Corinthians', 3, 9, 'If the ministry that condemns men is glorious, how much more glorious is the ministry that brings righteousness!');
INSERT INTO BIBLE VALUES
('NIV', '2 Corinthians', 3, 10, 'For what was glorious has no glory now in comparison with the surpassing glory.');
INSERT INTO BIBLE VALUES
('NIV', '2 Corinthians', 3, 11, 'And if what was fading away came with glory, how much greater is the glory of that which lasts!');
INSERT INTO BIBLE VALUES
('NIV', '2 Corinthians', 3, 12, 'Therefore, since we have such a hope, we are very bold.');
INSERT INTO BIBLE VALUES
('NIV', '2 Corinthians', 3, 13, 'We are not like Moses, who would put a veil over his face to keep the Israelites from gazing at it while the radiance was fading away.');
INSERT INTO BIBLE VALUES
('NIV', '2 Corinthians', 3, 14, 'But their minds were made dull, for to this day the same veil remains when the old covenant is read. It has not been removed, because only in Christ is it taken away.');
INSERT INTO BIBLE VALUES
('NIV', '2 Corinthians', 3, 15, 'Even to this day when Moses is read, a veil covers their hearts.');
INSERT INTO BIBLE VALUES
('NIV', '2 Corinthians', 3, 16, 'But whenever anyone turns to the Lord, the veil is taken away.');
INSERT INTO BIBLE VALUES
('NIV', '2 Corinthians', 3, 17, 'Now the Lord is the Spirit, and where the Spirit of the Lord is, there is freedom.');
INSERT INTO BIBLE VALUES
...
INSERT INTO BIBLE VALUES
('NIV', '2 Corinthians', 4, 5, 'For we do not preach ourselves, but Jesus Christ as Lord, and ourselves as your servants for Jesus’ sake.');
INSERT INTO BIBLE VALUES
('NIV', '2 Corinthians', 4, 6, 'For God, who said, “Let light shine out of darkness,” made his light shine in our hearts to give us the light of the knowledge of the glory of God in the face of Christ.');
INSERT INTO BIBLE VALUES
...
INSERT INTO BIBLE VALUES
('NIV', '2 Corinthians', 4, 8, 'We are hard pressed on every side, but not crushed; perplexed, but not in despair;');
INSERT INTO BIBLE VALUES
('NIV', '2 Corinthians', 4, 9, 'persecuted, but not abandoned; struck down, but not destroyed.');
INSERT INTO BIBLE VALUES
('NIV', '2 Corinthians', 4, 10, 'We always carry around in our body the death of Jesus, so that the life of Jesus may also be revealed in our body.');
INSERT INTO BIBLE VALUES
('NIV', '2 Corinthians', 4, 11, 'For we who are alive are always being given over to death for Jesus’ sake, so that his life may be revealed in our mortal body.');
INSERT INTO BIBLE VALUES
('NIV', '2 Corinthians', 4, 12, 'So then, death is at work in us, but life is at work in you.');
INSERT INTO BIBLE VALUES
('NIV', '2 Corinthians', 4, 13, 'It is written: “I believed; therefore I have spoken.” With that same spirit of faith we also believe and therefore speak,');
INSERT INTO BIBLE VALUES
('NIV', '2 Corinthians', 4, 14, 'because we know that the one who raised the Lord Jesus from the dead will also raise us with Jesus and present us with you in his presence.');
INSERT INTO BIBLE VALUES
('NIV', '2 Corinthians', 4, 15, 'All this is for your benefit, so that the grace that is reaching more and more people may cause thanksgiving to overflow to the glory of God.');
INSERT INTO BIBLE VALUES
('NIV', '2 Corinthians', 4, 16, 'Therefore we do not lose heart. Though outwardly we are wasting away, yet inwardly we are being renewed day by day.');
INSERT INTO BIBLE VALUES
...
INSERT INTO BIBLE VALUES
('NIV', '2 Corinthians', 4, 18, 'So we fix our eyes not on what is seen, but on what is unseen. For what is seen is temporary, but what is unseen is eternal.');
INSERT INTO BIBLE VALUES
('NIV', '2 Corinthians', 5, 1, 'Now we know that if the earthly tent we live in is destroyed, we have a building from God, an eternal house in heaven, not built by human hands.');
INSERT INTO BIBLE VALUES
('NIV', '2 Corinthians', 5, 2, 'Meanwhile we groan, longing to be clothed with our heavenly dwelling,');
INSERT INTO BIBLE VALUES
('NIV', '2 Corinthians', 5, 3, 'because when we are clothed, we will not be found naked.');
INSERT INTO BIBLE VALUES
('NIV', '2 Corinthians', 5, 4, 'For while we are in this tent, we groan and are burdened, because we do not wish to be unclothed but to be clothed with our heavenly dwelling, so that what is mortal may be swallowed up by life.');
INSERT INTO BIBLE VALUES
('NIV', '2 Corinthians', 5, 5, 'Now it is God who has made us for this very purpose and has given us the Spirit as a deposit, guaranteeing what is to come.');
INSERT INTO BIBLE VALUES
('NIV', '2 Corinthians', 5, 6, 'Therefore we are always confident and know that as long as we are at home in the body we are away from the Lord.');
INSERT INTO BIBLE VALUES
...
INSERT INTO BIBLE VALUES
('NIV', '2 Corinthians', 5, 9, 'So we make it our goal to please him, whether we are at home in the body or away from it.');
INSERT INTO BIBLE VALUES
('NIV', '2 Corinthians', 5, 10, 'For we must all appear before the judgment seat of Christ, that each one may receive what is due to him for the things done while in the body, whether good or bad.');
INSERT INTO BIBLE VALUES
('NIV', '2 Corinthians', 5, 11, 'Since, then, we know what it is to fear the Lord, we try to persuade men. What we are is plain to God, and I hope it is also plain to your conscience.');
INSERT INTO BIBLE VALUES
('NIV', '2 Corinthians', 5, 12, 'We are not trying to commend ourselves to you again, but are giving you an opportunity to take pride in us, so that you can answer those who take pride in what is seen rather than in what is in the heart.');
INSERT INTO BIBLE VALUES
('NIV', '2 Corinthians', 5, 13, 'If we are out of our mind, it is for the sake of God; if we are in our right mind, it is for you.');
INSERT INTO BIBLE VALUES
('NIV', '2 Corinthians', 5, 14, 'For Christ’s love compels us, because we are convinced that one died for all, and therefore all died.');
INSERT INTO BIBLE VALUES
...
INSERT INTO BIBLE VALUES
('NIV', '2 Corinthians', 5, 16, 'So from now on we regard no-one from a worldly point of view. Though we once regarded Christ in this way, we do so no longer.');
INSERT INTO BIBLE VALUES
('NIV', '2 Corinthians', 5, 17, 'Therefore, if anyone is in Christ, he is a new creation; the old has gone, the new has come!');
INSERT INTO BIBLE VALUES
('NIV', '2 Corinthians', 5, 18, 'All this is from God, who reconciled us to himself through Christ and gave us the ministry of reconciliation:');
INSERT INTO BIBLE VALUES
('NIV', '2 Corinthians', 5, 19, 'that God was reconciling the world to himself in Christ, not counting men’s sins against them. And he has committed to us the message of reconciliation.');
INSERT INTO BIBLE VALUES
...
INSERT INTO BIBLE VALUES
('NIV', '2 Corinthians', 6, 2, 'For he says, “In the time of my favour I heard you, and in the day of salvation I helped you.” I tell you, now is the time of God’s favour, now is the day of salvation.');
INSERT INTO BIBLE VALUES
...
INSERT INTO BIBLE VALUES
('NIV', '2 Corinthians', 6, 8, 'through glory and dishonour, bad report and good report; genuine, yet regarded as impostors;');
INSERT INTO BIBLE VALUES
...
INSERT INTO BIBLE VALUES
('NIV', '2 Corinthians', 8, 2, 'Out of the most severe trial, their overflowing joy and their extreme poverty welled up in rich generosity.');
INSERT INTO BIBLE VALUES
('NIV', '2 Corinthians', 8, 3, 'For I testify that they gave as much as they were able, and even beyond their ability. Entirely on their own,');
INSERT INTO BIBLE VALUES
('NIV', '2 Corinthians', 8, 4, 'they urgently pleaded with us for the privilege of sharing in this service to the saints.');
INSERT INTO BIBLE VALUES
('NIV', '2 Corinthians', 8, 5, 'And they did not do as we expected, but they gave themselves first to the Lord and then to us in keeping with God’s will.');
INSERT INTO BIBLE VALUES
('NIV', '2 Corinthians', 8, 6, 'So we urged Titus, since he had earlier made a beginning, to bring also to completion this act of grace on your part.');
INSERT INTO BIBLE VALUES
('NIV', '2 Corinthians', 8, 7, 'But just as you excel in everything—in faith, in speech, in knowledge, in complete earnestness and in your love for us— see that you also excel in this grace of giving.');
INSERT INTO BIBLE VALUES
('NIV', '2 Corinthians', 8, 8, 'I am not commanding you, but I want to test the sincerity of your love by comparing it with the earnestness of others.');
INSERT INTO BIBLE VALUES
('NIV', '2 Corinthians', 8, 9, 'For you know the grace of our Lord Jesus Christ, that though he was rich, yet for your sakes he became poor, so that you through his poverty might become rich.');
INSERT INTO BIBLE VALUES
('NIV', '2 Corinthians', 8, 10, 'And here is my advice about what is best for you in this matter: Last year you were the first not only to give but also to have the desire to do so.');
INSERT INTO BIBLE VALUES
...
INSERT INTO BIBLE VALUES
('NIV', '2 Corinthians', 8, 15, 'as it is written: “He who gathered much did not have too much, and he who gathered little did not have too little.”');
INSERT INTO BIBLE VALUES
('NIV', '2 Corinthians', 8, 16, 'I thank God, who put into the heart of Titus the same concern I have for you.');
INSERT INTO BIBLE VALUES
('NIV', '2 Corinthians', 8, 17, 'For Titus not only welcomed our appeal, but he is coming to you with much enthusiasm and on his own initiative.');
INSERT INTO BIBLE VALUES
...
INSERT INTO BIBLE VALUES
('NIV', '2 Corinthians', 8, 19, 'What is more, he was chosen by the churches to accompany us as we carry the offering, which we administer in order to honour the Lord himself and to show our eagerness to help.');
INSERT INTO BIBLE VALUES
...
INSERT INTO BIBLE VALUES
('NIV', '2 Corinthians', 8, 23, 'As for Titus, he is my partner and fellow-worker among you; as for our brothers, they are representatives of the churches and an honour to Christ.');
INSERT INTO BIBLE VALUES
...
INSERT INTO BIBLE VALUES
('NIV', '2 Corinthians', 9, 9, 'As it is written: “He has scattered abroad his gifts to the poor; his righteousness endures for ever.”');
INSERT INTO BIBLE VALUES
...
INSERT INTO BIBLE VALUES
('NIV', '2 Corinthians', 10, 2, 'I beg you that when I come I may not have to be as bold as I expect to be towards some people who think that we live by the standards of this world.');
INSERT INTO BIBLE VALUES
('NIV', '2 Corinthians', 10, 3, 'For though we live in the world, we do not wage war as the world does.');
INSERT INTO BIBLE VALUES
('NIV', '2 Corinthians', 10, 4, 'The weapons we fight with are not the weapons of the world. On the contrary, they have divine power to demolish strongholds.');
INSERT INTO BIBLE VALUES
...
INSERT INTO BIBLE VALUES
('NIV', '2 Corinthians', 10, 7, 'You are looking only on the surface of things. If anyone is confident that he belongs to Christ, he should consider again that we belong to Christ just as much as he.');
INSERT INTO BIBLE VALUES
('NIV', '2 Corinthians', 10, 8, 'For even if I boast somewhat freely about the authority the Lord gave us for building you up rather than pulling you down, I will not be ashamed of it.');
INSERT INTO BIBLE VALUES
('NIV', '2 Corinthians', 10, 9, 'I do not want to seem to be trying to frighten you with my letters.');
INSERT INTO BIBLE VALUES
('NIV', '2 Corinthians', 10, 10, 'For some say, “His letters are weighty and forceful, but in person he is unimpressive and his speaking amounts to nothing.”');
INSERT INTO BIBLE VALUES
('NIV', '2 Corinthians', 10, 11, 'Such people should realise that what we are in our letters when we are absent, we will be in our actions when we are present.');
INSERT INTO BIBLE VALUES
('NIV', '2 Corinthians', 10, 12, 'We do not dare to classify or compare ourselves with some who commend themselves. When they measure themselves by themselves and compare themselves with themselves, they are not wise.');
INSERT INTO BIBLE VALUES
('NIV', '2 Corinthians', 10, 13, 'We, however, will not boast beyond proper limits, but will confine our boasting to the field God has assigned to us, a field that reaches even to you.');
INSERT INTO BIBLE VALUES
('NIV', '2 Corinthians', 10, 14, 'We are not going too far in our boasting, as would be the case if we had not come to you, for we did get as far as you with the gospel of Christ.');
INSERT INTO BIBLE VALUES
('NIV', '2 Corinthians', 10, 15, 'Neither do we go beyond our limits by boasting of work done by others. Our hope is that, as your faith continues to grow, our area of activity among you will greatly expand,');
INSERT INTO BIBLE VALUES
('NIV', '2 Corinthians', 10, 16, 'so that we can preach the gospel in the regions beyond you. For we do not want to boast about work already done in another man’s territory.');
INSERT INTO BIBLE VALUES
('NIV', '2 Corinthians', 10, 17, 'But, “Let him who boasts boast in the Lord.”');
INSERT INTO BIBLE VALUES
...
INSERT INTO BIBLE VALUES
('NIV', '2 Corinthians', 11, 27, 'I have laboured and toiled and have often gone without sleep; I have known hunger and thirst and have often gone without food; I have been cold and naked.');
INSERT INTO BIBLE VALUES
...
INSERT INTO BIBLE VALUES
('NIV', '2 Corinthians', 11, 31, 'The God and Father of the Lord Jesus, who is to be praised for ever, knows that I am not lying.');
INSERT INTO BIBLE VALUES
...
INSERT INTO BIBLE VALUES
('NIV', '2 Corinthians', 12, 1, 'I must go on boasting. Although there is nothing to be gained, I will go on to visions and revelations from the Lord.');
INSERT INTO BIBLE VALUES
...
INSERT INTO BIBLE VALUES
('NIV', '2 Corinthians', 12, 3, 'And I know that this man—whether in the body or apart from the body I do not know, but God knows—');
INSERT INTO BIBLE VALUES
('NIV', '2 Corinthians', 12, 4, 'was caught up to paradise. He heard inexpressible things, things that man is not permitted to tell.');
INSERT INTO BIBLE VALUES
...
INSERT INTO BIBLE VALUES
('NIV', '2 Corinthians', 12, 11, 'I have made a fool of myself, but you drove me to it. I ought to have been commended by you, for I am not in the least inferior to the “super-apostles”, even though I am nothing.');
INSERT INTO BIBLE VALUES
('NIV', '2 Corinthians', 12, 12, 'The things that mark an apostle—signs, wonders and miracles—were done among you with great perseverance.');
INSERT INTO BIBLE VALUES
('NIV', '2 Corinthians', 12, 13, 'How were you inferior to the other churches, except that I was never a burden to you? Forgive me this wrong!');
INSERT INTO BIBLE VALUES
('NIV', '2 Corinthians', 12, 14, 'Now I am ready to visit you for the third time, and I will not be a burden to you, because what I want is not your possessions but you. After all, children should not have to save up for their parents, but parents for their children.');
INSERT INTO BIBLE VALUES
('NIV', '2 Corinthians', 12, 15, 'So I will very gladly spend for you everything I have and expend myself as well. If I love you more, will you love me less?');
INSERT INTO BIBLE VALUES
('NIV', '2 Corinthians', 12, 16, 'Be that as it may, I have not been a burden to you. Yet, crafty fellow that I am, I caught you by trickery!');
INSERT INTO BIBLE VALUES
('NIV', '2 Corinthians', 12, 17, 'Did I exploit you through any of the men I sent you?');
INSERT INTO BIBLE VALUES
('NIV', '2 Corinthians', 12, 18, 'I urged Titus to go to you and I sent our brother with him. Titus did not exploit you, did he? Did we not act in the same spirit and follow the same course?');
INSERT INTO BIBLE VALUES
('NIV', '2 Corinthians', 12, 19, 'Have you been thinking all along that we have been defending ourselves to you? We have been speaking in the sight of God as those in Christ; and everything we do, dear friends, is for your strengthening.');
INSERT INTO BIBLE VALUES
('NIV', '2 Corinthians', 12, 20, 'For I am afraid that when I come I may not find you as I want you to be, and you may not find me as you want me to be. I fear that there may be quarrelling, jealousy, outbursts of anger, factions, slander, gossip, arrogance and disorder.');
INSERT INTO BIBLE VALUES
('NIV', '2 Corinthians', 12, 21, 'I am afraid that when I come again my God will humble me before you, and I will be grieved over many who have sinned earlier and have not repented of the impurity, sexual sin and debauchery in which they have indulged.');
INSERT INTO BIBLE VALUES
('NIV', '2 Corinthians', 13, 1, 'This will be my third visit to you. “Every matter must be established by the testimony of two or three witnesses.”');
INSERT INTO BIBLE VALUES
('NIV', '2 Corinthians', 13, 2, 'I already gave you a warning when I was with you the second time. I now repeat it while absent: On my return I will not spare those who sinned earlier or any of the others,');
INSERT INTO BIBLE VALUES
('NIV', '2 Corinthians', 13, 3, 'since you are demanding proof that Christ is speaking through me. He is not weak in dealing with you, but is powerful among you.');
INSERT INTO BIBLE VALUES
('NIV', '2 Corinthians', 13, 4, 'For to be sure, he was crucified in weakness, yet he lives by God’s power. Likewise, we are weak in him, yet by God’s power we will live with him to serve you.');
INSERT INTO BIBLE VALUES
('NIV', '2 Corinthians', 13, 5, 'Examine yourselves to see whether you are in the faith; test yourselves. Do you not realise that Christ Jesus is in you— unless, of course, you fail the test?');
INSERT INTO BIBLE VALUES
('NIV', '2 Corinthians', 13, 6, 'And I trust that you will discover that we have not failed the test.');
INSERT INTO BIBLE VALUES
('NIV', '2 Corinthians', 13, 7, 'Now we pray to God that you will not do anything wrong. Not that people will see that we have stood the test but that you will do what is right even though we may seem to have failed.');
INSERT INTO BIBLE VALUES
('NIV', '2 Corinthians', 13, 8, 'For we cannot do anything against the truth, but only for the truth.');
INSERT INTO BIBLE VALUES
('NIV', '2 Corinthians', 13, 9, 'We are glad whenever we are weak but you are strong; and our prayer is for your perfection.');
INSERT INTO BIBLE VALUES
('NIV', '2 Corinthians', 13, 10, 'This is why I write these things when I am absent, that when I come I may not have to be harsh in my use of authority— the authority the Lord gave me for building you up, not for tearing you down.');
INSERT INTO BIBLE VALUES
...
INSERT INTO BIBLE VALUES
('NIV', '2 Corinthians', 13, 13, 'All the saints send their greetings.');
INSERT INTO BIBLE VALUES
